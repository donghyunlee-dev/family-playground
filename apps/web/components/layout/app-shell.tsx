        ...
        <header className="rounded-[1.9rem] border border-[#ffdca8] bg-[#fffdf9] p-4 shadow-[0_18px_42px_rgba(245,158,11,0.1)] md:rounded-[2.5rem] md:p-6 md:shadow-[0_24px_70px_rgba(245,158,11,0.12)]">
          <div className="flex flex-col gap-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <Link
                className="rounded-full border border-[#fecaca] bg-[#fef2f2] px-3 py-2 text-sm font-medium text-[#b91c1c] transition hover:bg-[#fee2e2] hover:text-[#991b1b]"
                href="/auth/sign-out"
              >
                로그아웃
              </Link>
              ...
              <Link
                ...
                className={`flex items-center justify-center rounded-[1rem] px-3 py-2.5 text-sm font-medium transition md:rounded-full md:px-4 md:py-2 ${
                  pathname.startsWith(item.href)
                    ? "border border-[#ffb84d] bg-[#fff2cf] text-[#1f2a44]"
                    : "border border-[#ffd58c] bg-white text-[#34415f] hover:border-[#ffb84d] hover:bg-[#fff2cf] hover:text-[#1f2a44]"
                }`}
                href={item.href}
              >
                {item.label}
